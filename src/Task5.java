public class Task5 {
    public static void main(String[] args) {
        ...
        System.out.println("За месяц машина произвела " + bottlesPerOneMonts + " штук бутылок.");
