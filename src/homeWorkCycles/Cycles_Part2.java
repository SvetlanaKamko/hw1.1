...
public class Cycles_Part2 {
    ...
    /*Условия предыдущей задачи: Посчитайте с помощью цикла for сумму годовых накоплений,
//        если каждый месяц вы будете откладывать по 29 000 рублей «в банку».
   ...
   что первоначально мы имеем 0 рублей и готовы откладывать по 15 тысяч рублей.*/
    ...
    public static void task3() {
        ...
        int populationGrowthPerYear = population / 1000 * 9;
        int year = 2024;
        while (year < 2034) {
            year++;
            population = population + populationGrowthPerYear;
    ...
    public static void task8() {
      ...
      до текущего (из созданной ранее переменной) в качестве старта и 100 лет после в качестве завершения периода расчета.
        ...
        1975
        2054*/
        int yearCometPeriod = 79;
        int yearNow = 2024;
        int yearStartPeriod = yearNow - 200;
        int yearFinishPeriod = yearNow + 100;
        for (int yearPeriod = yearStartPeriod; yearPeriod < yearFinishPeriod; yearPeriod++) {
            if (yearPeriod % yearCometPeriod == 0) {
